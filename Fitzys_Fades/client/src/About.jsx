function About() {
  ...
  return (
    <>
      <main>
        <h2 className="text-left text-4xl text-cyan-600 ml-40 font-semibold">About Us</h2>
        <div className="flex items-center">
          <img src="images/owner_of_shop.jpg" alt="Placeholder" className="mr-4"></img>

          <div>
            <p className="text-7xl text-cyan-600 text-right mr-40 font-semibold">Fitzy Fades</p>
            <p className="text-orange-200">Welcome to Fitzys Fades, where we blend artistry and precision to create exceptional hairstyles for our clients. At Fitzys Fades, we take immense pride in our work, ensuring that every haircut is a masterpiece that reflects our dedication to excellence. Our team of skilled barbers is passionate about their craft, constantly honing their skills to stay updated with the latest trends and techniques in the industry.<br>
          </br>
          <br></br>
          <br></br>
