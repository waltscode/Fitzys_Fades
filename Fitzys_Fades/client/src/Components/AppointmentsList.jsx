...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <select id="orderBy" name="orderBy" className="mt-1 block w-full p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" onChange={handleOrderByChange}>
