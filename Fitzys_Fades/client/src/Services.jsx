      ...
      <body className="service-bkg">
        ...
        <main>
          ...
          <div className="flex flex-wrap justify-center">
            ...
            {/* Straight Razor */}
            <div className="flex flex-col bg-cyan-600 rounded-lg shadow-md p-2 mr-8 mb-14">
              <div className="relative">
                <div className="relative">
                  <img
              ...
              <div className="relative">
                <div className="relative">
                  ...
                  <div className="absolute top-0 right-0 p-2 z-2">
                    ...
                    <p className="text-teal-200 mb-2 text-right">$40</p>
                  </div>
                </div>
                {/* Book Now Button */}
                <button
                  className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:bg-blue-600"
                  onClick={() => {
                    handleServiceSelection("Classic Cuts");
